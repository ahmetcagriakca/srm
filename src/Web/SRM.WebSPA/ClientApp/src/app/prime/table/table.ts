...
import { SortMeta, DomHandler, BlockableUI, FilterMetadata, PrimeTemplate, Column, PaginatorModule, SharedModule } from 'primeng/primeng';
...
export class Table implements OnInit, AfterViewInit, AfterContentInit, BlockableUI {
	...
	filterConstraints = {
		...
		range(value, filter: any[]): boolean {
			if (filter === undefined || filter === null) {
				return true;
			}
