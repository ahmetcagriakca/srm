...
namespace Fix.Utility.Runtime
{

    public class ClassBuilder
    {
        public AssemblyName asemblyName { get; set; }
        ...
        private TypeBuilder CreateClass()
        {
            ...
            try
            {
                ASM = moduleBuilder.Assembly;
                //  typeBuilder.AddInterfaceImplementation(typeof(IPolicyBase));
            }
            catch (Exception ex)
            {
